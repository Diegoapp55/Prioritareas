...
entrada_descripcion.grid(row=0, column=1, padx=10, pady=10)
etiqueta_fecha.grid(row=1, column=0, padx=10, pady=10)
entrada_fecha.grid(row=1, column=1, padx=10, pady=10)
etiqueta_prioridad.grid(row=2, column=0, padx=10, pady=10)
